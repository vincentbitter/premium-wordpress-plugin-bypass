...
if ($cff_show_media_link && ($cff_post_type == 'video' || $cff_album)):
...
if ($cff_show_media_link && ($cff_post_type == 'photo')):
    echo "<div><img src=" . esc_url($news->picture) . " class='cff-media-image' /></div>";
endif;
